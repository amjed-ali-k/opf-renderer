...
This file is a copy of `assign_markers_to_bboxes.py`, kept as a stable CLI entrypoint
while the original script can evolve or be used as an importable module.
"""
